        ...
        <div class="card-body">
          ...
          <input type="hidden" name="id" value="' . $id . '">  
            ...
            <div class="mb-3 col-6">
              ...
              <input type="number" name="future_car" style="font-size:16px;" class="form-control form-control-sm" id="futureYearcar" value="' . $decode['futureyear'] . '"  />
            </div>
            ...
            <div class="mb-3 col-6">
              ...
              <input type="number" name="car_current" style="font-size:16px;" class="form-control form-control-sm" id="currentCostcar" value="' . $decode['current'] . '"  />
            </div>
            ...
            <h3 for="inflation" class="form-label" style="background-color: gray;text-align:center;padding:6px;border-radius:5px;color:white; border: 1px solid black;font-size:22px;">Inflation Rate</h3>
              <input  type="number" name="car_inflation" style="font-size:12px;" class="form-control form-control-sm" id="inflationcar" value="' . $decode['inflacar'] . '" />
            </div>
            ...
            <h3 for="futureValue" class="form-label" style="background-color: gray;text-align:center;padding:6px;border-radius:5px;color:white; border: 1px solid black;font-size:22px;">Future Value</h3>
              <input type="number" name="car_value" class="form-control form-control-sm" style="font-size:19px;" id="futureValuecar" value="' . $decode['ansinputs'] . '" readonly="true" />
            </div>
            ...
            <h3 for="futureValue" class="form-label" style="background-color: gray;text-align:center;padding:6px;border-radius:5px;color:white; border: 1px solid black;font-size:22px;">SIP Required</h3>
              <input type="number" name="car_sip" class="form-control form-control-sm" style="font-size:19px;" id="sipValuecar" value="' . $decode['sipvalue'] . '" readonly="true" />
            </div>
