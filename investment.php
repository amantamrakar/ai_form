...
<body>
                    ...
                    <div class="modal-body">
                        <table class="resp_table">
                            <thead class='text-center'>
                                <tr>
                                    <th class='text-center' scope='col' data-label='Funds Type'>Funds Type</th>
                                    <th class='text-center' scope='col' data-label='Invested Amount'>Invested Amount</th>
                                    <th class='text-center' scope='col' data-label='Duration'>Duration</th>
                                    <th class='text-center' scope='col' data-label='Interest'>Interest</th>
                                </tr>
                            </thead>
                            <tbody id='list_fund'>
    ...
    <script>
        ...
        $("#topUpSave").click(function(e) {
            ...
            const data = {};
            let valid = true;
            $("input.check_val").each((i, el) => {
                if(!check_val({"target":el})){
                    valid = false;
                }
            })
            $("input#mothly_sip").each((i, el) => {
                data[el.dataset.sgid] = {};
                data[el.dataset.sgid]["sip"] = $(`input#mothly_sip[data-sgid="${el.dataset.sgid}"]`).val()
