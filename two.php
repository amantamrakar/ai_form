 <fieldset>
     ...
     <div class="goals education" data-goal="education"> <br>
         ...
         <div class="row">
             ...
             <div class="col-6 col-sm-5" id="imgchild">
                 <div style="display:block;">
                     <img src="images\11boybaby.jpg" alt="" style="width:55%;">
                 </div>
             </div>
     ...
     <div class="goals car" data-goal="car">
         ...
         <div class="row">
             ...
             <div class="col-md-6 col-sm-4">
                 <img src="./images/carimage.jpg" style="width:100%;" alt="">
             </div>
         </div>
     </div>
     <!-----------------------------vacation----------------------------------------------->
     ...
     <div class="goals vacation" data-goal="vacation">
         ...
         <div class="row">
             ...
             <div class="col-md-6 col-sm-4">
                 <img src="./images/vacimg.jpg" style="width:100%;" alt="">
             </div>
         </div>
     </div>
     <!-----------------------------Tax Saving ----------------------------------------------->
         ...
         <div class="row">
             ...
             <div class="col-7">
                 ...
                 <div class="form-group row">
                     ...
                     <input type="text" style="width:70%;" class="form-control allinput input-selector calculatehouse borderhigh" name="futureage" oninput="othergoalcal()" id="futureval" placeholder="How many year ?">
                 </div>
                 <div class="form-group row">
                 ...
                 <div class="form-group row">
                     ...
                     <input type="text" style="width:70%;" class="form-control allinput input-selector calculatehouse borderhigh" name="inflation" oninput="othergoalcal()" id="inflaother" placeholder="Inflation rate">
                 </div>
                 <div class="form-group row d-none">
     ...
     <div style="text-align:center" class="mt-2">
         ...
         <input type="button" name="next" onclick="namebtn()" class="next btn btn-primary" value="Next" id="btn-2" disabled />
     </div>
 </fieldset>